...
WHERE 
(
    (m.sender_id = $sender_id AND m.sender_designation = '$sender_designation' AND m.receiver_id = $receiver_id AND m.receiver_designation = 'teacher') 
    OR 
    (m.receiver_id = $sender_id AND m.receiver_designation = '$sender_designation' AND m.sender_id = $receiver_id AND m.sender_designation = 'teacher')
)
