...
$check_sql = "SELECT id FROM school_settings WHERE person = 'admin' AND person_id = ?";
...
if ($check_stmt->num_rows > 0) {
    ...
    $sql = "UPDATE school_settings SET " . implode(", ", $fields) . " WHERE person = 'admin' AND person_id = ?";
    $params[] = $admin_id;
    $types .= "i";
